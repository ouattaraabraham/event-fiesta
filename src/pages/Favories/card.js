...
import {AiFillHeart,AiOutlineShareAlt,AiFillLeftCircle,AiFillRightCircle } from "react-icons/ai";
    ...
    <div>
     ...
     <div className='px-4 pb-5 pt-3 flex flex-col gap-1 cursor-default'>
        ...
        <div className='flex gap-4 cursor-pointer'>
          ...
          <button onClick={()=>toggleFavori(item)}><AiFillHeart size={23} color='red'/></button>
        </div>
       </div>
    ...
    {/* block detail */}
    {
        detail?(
         <div className=' fixed top-0 left-0 flex flex-col w-full h-screen  z-50'>
             {/*BtnClose */}
          <div className='relative mx-auto lg:m-auto rounded-lg '>
            <div className='bg-[#e9e9e9] flex flex-col relative w-full h-screen lg:w-[75vw] lg:h-[85vh] rounded-lg  '>
              {/* header detail */}
              <div className=' bg-[#f0f8ff] text-lg flex justify-between py-3 px-3 md:px-5'>
                <div>
                  ...
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2 text-white'>
                    {
                      item.adapter.map(item=>
                        <span className='px-3 py-[0.3rem] rounded-xl bg-[#413f3f]'>{item}</span>
                      )                         
                    }
                    </div>
                  </div>
              ...
              <div className='bg-[#f0f8ff] text-[#f0f8ff] '>
                <div className=' flex flex-wrap  justify-center md:justify-end py-3 md:px-4  gap-3 '>
             ...
             {/* true block */}
              <div className='bg-[#f0f8ff] w-full absolute bottom-0 z-20'>
                <div className=' flex flex-wrap  justify-center md:justify-end py-3 md:px-4  gap-3 '>
